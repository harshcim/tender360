...
from langchain_community.document_loaders import DirectoryLoader,PyPDFLoader,UnstructuredFileLoader, UnstructuredWordDocumentLoader
...
VECTOR_DB_PATH = os.path.abspath("./data/vector_store.faiss")
